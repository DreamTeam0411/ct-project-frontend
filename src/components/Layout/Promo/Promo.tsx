      ...
      <div className={styles.promoContainer}>
        ...
        <div className={styles.promoButtonContainer}>
            <NavLink to={'/all-services'}>
                <button className={styles.promoButton}>Записатись <svg xmlns="http://www.w3.org/2000/svg" width="100%"
                                                                       height="100%"
                                                                       >
                    <path fill="white" d="M7 7h8.586L5.293 17.293l1.414 1.414L17 8.414V17h2V5H7v2z"/>
                </svg>
                </button>
            </NavLink>
        </div>
          <div className={styles.promoRightBlock}>
              <img src="/PromoBanner.jpg" alt="promo-image"/>
          </div>
      </div>
  );
};
