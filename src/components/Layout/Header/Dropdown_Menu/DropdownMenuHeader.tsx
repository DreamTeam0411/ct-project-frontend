      ...
      >
        ...
        <ul className={style.menu__list}>
          ...
          <li className={style.menu__item__categorie}>
            <Link
              to="/all-services/?category=dogliad-za-nigtiami"
          ...
          <li className={style.menu__item__categorie}>
            <Link
              to="/all-services/?category=makiiaz"
              className={style.menu__link}
            >
          ...
          <li className={style.menu__item__categorie}>
            <Link
              to="/all-services/?category=zinoca-strizka"
              className={style.menu__link}
            >
              <button className={style.menu__link__target}>
                Жіноча стрижка
          ...
          <li className={style.menu__item__categorie}>
            <Link
              to="/all-services/?category=farbuvannia-volossia"
              className={style.menu__link}
            >
              <button className={style.menu__link__target}>
                Фарбування волосся
          ...
          <li className={style.menu__item__categorie}>
            <Link
              to="/all-services/?category=vidalennia-volossia"
              className={style.menu__link}
            >
              <button className={style.menu__link__target}>
                Видалення волосся
          ...
          <li className={style.menu__item__categorie}>
            <Link
              to="/all-services/?category=colovica-strizka"
              className={style.menu__link}
            >
              <button className={style.menu__link__target}>
                Чоловіча стрижка
          ...
          <li className={style.menu__item__categorie}>
            <Link
              to="/all-services/?category=viyi-ta-brovi"
              className={style.menu__link}
            >
              <button className={style.menu__link__target}>Вії та брови</button>
            </Link>
          </li>
          <li className={style.menu__item__categorie}>
            <Link
              to="/all-services/?category=masaz"
              className={style.menu__link}
            >
              <button className={style.menu__link__target}>Масаж</button>
            </Link>
          </li>
          <li className={style.menu__item__categorie}>
            <Link
              to="/all-services/?category=tatuaz"
              className={style.menu__link}
            >
              <button className={style.menu__link__target}>Татуаж</button>
            </Link>
          </li>
          <li className={style.menu__item__categorie}>
            <Link
              to="/all-services/?category=kosmetologiia"
              className={style.menu__link}
            >
              <button className={style.menu__link__target}>Косметологія</button>
            </Link>
          </li>
        </ul>
      </nav>
